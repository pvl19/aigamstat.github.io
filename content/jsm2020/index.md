...
3. Activities
  * [Sessions during this JSM](https://astrostat.org/jsm2020/)
  * [Student Paper Award](#session-401)
  * [AIG Virtual Table](https://amstat-jsm.conferencecontent.net/exhibitors/88)
  * AIG Mixer on Wed Aug 5 5-6pm via Zoom; see [Slack Channel](https://astrostatisti-dzq6013.slack.com/archives/C011GJMLLET) for connection information
  * [Planning for next year](https://docs.google.com/document/d/1L2QQuUqAYxvSv2OlSRlYtsvk0vdO8iDa3gLQHk6lS3k/edit?usp=sharing)
  * Other events
4. External Coordination
5. Web presence
  * Website, contact email, and email exploder
  * Social media: [Slack](https://astrostatisti-dzq6013.slack.com/archives/C011GJMLLET), twitter, etc
  * Logo
...
- `1:05 PM` 	**Handling Model Uncertainty via Smoothed Inference** [[Slides]](https://drive.google.com/file/d/17U864ED7Udk6REh-bez_Y9C53TiGudUT/view)  
...
- `1:55 PM` 	**Disentangling Stellar Activity and Planetary Signals using Bayesian High-dimensional Analysis** [[Slides]](https://drive.google.com/file/d/1xE8pIMkeCpwam4s--xFWQUjOufd4XBRM/view?usp=sharing)  
...
- `1:45 PM` 	**Likelihood-free Inference of Chemical Homogeneity in Open Clusters** [[Slides]](https://drive.google.com/file/d/1Os66UQDMijarvUjjha08KuPFTcJCzOzG/view)  
...
- `1:05 PM` 	**Photometric Biases in Modern Astronomical Surveys** [[Slides]](https://drive.google.com/file/d/16Rv5mAOoVglS-uKywmcNCl7LRFDqrbkD/view?usp=sharing)  
...
- `1:25 PM` 	**Trend Filtering: A Modern Statistical Tool for Time-Domain Astronomy and Astronomical Spectroscopy** [[Slides]](https://drive.google.com/file/d/1kXAEZG-s5Kh_4gLGCQ7687t2Fe6rt54b/view?usp=sharing)    
...
- `1:45 PM` 	**Galaxy Cluster Mass Estimation Using Deep Learning** [[Slides]](https://drive.google.com/file/d/1Bk2k3kLyjrJrSl78ZUbGxPDxNSkdBvwj/view?usp=sharing)  
...
- `2:05 PM` 	**Inferring Galactic Parameters from Chemical Abundances: A Multi-Star Approach** [[Slides]](https://drive.google.com/file/d/1GbjMPv0IwNmRZiw-OtmdDxvOAtrr3UdA/view?usp=sharing)  
...
- `10:25 AM` 	**X-ray data and its many challenges** [[Slides]](https://drive.google.com/file/d/1RREaA7WWLOm7npx0UmROkK_NQkptzyaz/view?usp=sharing)  
...
- `10:45 AM` 	**Gaia data: challenges for the exploitation of a large and complex dataset** [[Slides]](https://drive.google.com/file/d/1gT_wXK-1Fp1j5FNTeBOYMP8P1OUoQKqe/view?usp=sharing)  
...
- `11:05 AM` 	**Solar (Data) Explosion: Challenges in Using Large Astrophysical Imaging Data Sets.** [[Slides]](https://drive.google.com/file/d/1RLIdB8R6YQ7NWium7pw3YosDsuogpv32/view)  
...
- `1:25 PM` 	**Experimental design and discovery of unknown unknowns with the Rubin Observatory Legacy Survey of Space and Time** [[Slides]](https://drive.google.com/file/d/1anP6NgpAfY8kOi8cQJh8wsssMszWeoEN/view)  
