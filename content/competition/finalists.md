...
Maximilian Autenrieth (Organizer) David van Dyk (Organizer and Chair)\
[Link to JSM session](https://ww2.amstat.org/meetings/jsm/2026/onlineprogram/session.cfm?id=6517)

## Finalists

- ***A Bayesian Hierarchical Framework for Inferring the Planetary Obliquity Distribution***
  * **Michael Poon** (University of Toronto); Co-authors: Marta Bryan (Penn State University), Hanno Rein (University of Toronto), Jiayin Dong (University of Illinois at Urbana-Champaign), Joshua Speagle (University of Toronto), Dang Pham (CU Boulder)
- ***A Novel Statistical Framework for Recovering Radial Velocities from Line-by-Line Spectral Data***
  * **Joseph Salzer** (University of Wisconsin-Madison); Co-authors: Jessi Cisewski-Kehe (University of Wisconsin-Madison), Eric Ford (Pennsylvania State University), Lily L. Zhao (University of Chicago)
